var Brique = /** @class */ (function () {
    function Brique(gridElement, options) {
        ...
        this.itemElements = [].slice.call(this.gridElement.children);
    ...
    Brique.prototype.resize = function () {
        ...
        (_a = this.itemElements) === null || _a === void 0 ? void 0 : _a.forEach(function (item, index) {
            ...
            var itemSpacing = parseInt(itemComputedStyle.getPropertyValue('margin-top')) +
                parseInt(itemComputedStyle.getPropertyValue('padding-top')) +
                parseInt(itemComputedStyle.getPropertyValue('padding-bottom'));
            var itemHeight = [].slice.call(item.children).reduce(function (acc, curr) {
